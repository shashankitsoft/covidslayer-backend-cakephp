<div class="players index">
	...
	<tr>
		...
		<td><?php echo h($player['Player']['email']); ?>&nbsp;</td>
		<td><?php echo h($player['Player']['password']); ?>&nbsp;</td>
		<td><?php echo h($player['Player']['avatar']); ?>&nbsp;</td>
		<td><?php echo h($player['Player']['status']); ?>&nbsp;</td>
		<td><?php echo h($player['Player']['token']); ?>&nbsp;</td>
		<td><?php echo h($player['Player']['created_at']); ?>&nbsp;</td>
		<td><?php echo h($player['Player']['updated_at']); ?>&nbsp;</td>
		<td class="actions">
